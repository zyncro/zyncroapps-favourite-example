<div class="config-favorite-zapp">
    ...
    <p class="favorite-config-text">[[ title ]]</p>
    <div style="clear: both"></div>
    <div class="popup-favorite-config-buttons">

        <input class="button accept-button-favorite-config" value="[[ accept ]]">
        <a class="cancel-button-favorite-config" onclick="return false;">[[ cancel ]]</a>
    </div>
</div>